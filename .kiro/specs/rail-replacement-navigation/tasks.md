...
- [x] 1. Set up project structure, tooling, and core interfaces
  - [x] 1.1 Set up TypeScript build tooling and project scaffolding
  ...
  - [x] 1.3 Create sample static route JSON data file
...
- [x] 2. Implement hash router and application state
  ...
  - [x] 2.2 Write property test for URL parsing round trip
    - **Property 1: URL Parsing Round Trip**
    - **Validates: Requirements 1.2**

  - [x] 2.3 Write property test for malformed URL rejection
    - **Property 2: Malformed URL Rejection**
    - **Validates: Requirements 1.4**

  - [x] 2.4 Implement application state store
...
- [x] 3. Implement data services
  - [x] 3.1 Implement RouteDataService
  ...
  - [x] 3.2 Implement DepartureService
  ...
  - [x] 3.3 Write property test for next departures computation
    - **Property 6: Next Departures Computation**
    - **Validates: Requirements 4.5, 5.4, 6.1, 6.2, 6.3**

  - [x] 3.4 Implement GeolocationService
...
- [x] 5. Implement screen components - Journey Confirmation and Connection Overview
  - [x] 5.1 Implement JourneyConfirmationScreen component
  ...
  - [x] 5.2 Write property test for journey confirmation rendering
    - **Property 3: Journey Confirmation Renders All Connection Fields**
    - **Validates: Requirements 2.1**

  - [x] 5.3 Implement ConnectionOverviewScreen component
  ...
  - [x] 5.4 Write property test for connection list completeness
    - **Property 4: Connection List Completeness**
    - **Validates: Requirements 3.1, 3.3**

- [x] 6. Implement screen components - Navigation Preview
  - [x] 6.1 Implement BusDepartureInfo component
  ...
  - [x] 6.2 Implement NavigationPreviewScreen component
  ...
  - [x] 6.3 Write property test for navigation preview milestone summary
    - **Property 5: Navigation Preview Milestone Summary**
    - **Validates: Requirements 4.1**

- [x] 7. Implement Navigation Screen - Text Directions View
  - [x] 7.1 Implement MilestoneCard component
  ...
  - [x] 7.2 Write property test for milestone rendering completeness
    - **Property 7: Milestone Rendering Completeness**
    - **Validates: Requirements 5.1**

  - [x] 7.3 Write property test for accessible milestone feature label rendering
    - **Property 12: Accessible Milestone Feature Label Rendering**
    - **Validates: Requirements 8.4**

  - [x] 7.4 Implement SwipeContainer component
  ...
  - [x] 7.5 Write property test for milestone index state transitions
    - **Property 8: Milestone Index State Transitions**
    - **Validates: Requirements 5.2**

  - [x] 7.6 Implement DotIndicator component
  ...
  - [x] 7.7 Write property test for dot indicator correctness
    - **Property 9: Dot Indicator Correctness**
    - **Validates: Requirements 5.3**

- [x] 8. Implement Navigation Screen - Map View and View Toggle
  - [x] 8.1 Implement MapViewComponent
  ...
  - [x] 8.2 Write property test for walking distance and duration calculation
    - **Property 10: Walking Distance and Duration Calculation**
    - **Validates: Requirements 7.5**

  - [x] 8.3 Implement NavigationScreen with view toggle
...
- [x] 9. Checkpoint - All screens and navigation functional
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Implement accessible navigation and validation
  - [x] 10.1 Wire accessible navigation mode
  ...
  - [x] 10.2 Write property test for accessible route data validity
    - **Property 11: Accessible Route Data Validity**
    - **Validates: Requirements 8.1, 8.2**

- [x] 11. Wire application together and configure entry point
  - [x] 11.1 Wire all components into the main application shell
  ...
  - [x] 11.2 Add responsive mobile styling
