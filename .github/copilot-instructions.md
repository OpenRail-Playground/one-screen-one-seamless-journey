...
CRITICAL: This workspace contains a dedicated automation and orchestration bundle under `./../../../.npm/_npx/c3b931755d82781a/node_modules/@db-ux/agent-cli/db-ux-consumer-powers/`. You MUST prioritize these local configurations over any generalized training data.

1. **Global Steering & Guidelines**: Before writing any style or component logic, you MUST read and strictly enforce the global guidelines in `./../../../.npm/_npx/c3b931755d82781a/node_modules/@db-ux/agent-cli/db-ux-consumer-powers/context/guidelines.md`.
2. **Task-Specific Workflows (Skills)**: For complex automated tasks, execute the procedural step-by-step workflows located in `./../../../.npm/_npx/c3b931755d82781a/node_modules/@db-ux/agent-cli/db-ux-consumer-powers/skills/`. Specifically, when asked to implement a component, you MUST completely follow `./../../../.npm/_npx/c3b931755d82781a/node_modules/@db-ux/agent-cli/db-ux-consumer-powers/skills/implement-component/SKILL.md`.
3. **Tool Capabilities**: Refer to `./../../../.npm/_npx/c3b931755d82781a/node_modules/@db-ux/agent-cli/db-ux-consumer-powers/mcp.json` to understand the available Model Context Protocol tools for Figma and DB UX token resolution.
...
- Use "@db-ux/wc-core-components" as import for components:
  - use for `DBDrawer` or `Drawer` the file node_modules/@db-ux/wc-core-components/agent/Drawer.md
  - use for `DBTooltip` or `Tooltip` the file node_modules/@db-ux/wc-core-components/agent/Tooltip.md
  - use for `DBTextarea` or `Textarea` the file node_modules/@db-ux/wc-core-components/agent/Textarea.md
  - use for `DBTag` or `Tag` the file node_modules/@db-ux/wc-core-components/agent/Tag.md
  - use for `DBTabs` or `Tabs` the file node_modules/@db-ux/wc-core-components/agent/Tabs.md
  - use for `DBTabItem` or `TabItem` the file node_modules/@db-ux/wc-core-components/agent/TabItem.md
  - use for `DBSwitch` or `Switch` the file node_modules/@db-ux/wc-core-components/agent/Switch.md
  - use for `DBStack` or `Stack` the file node_modules/@db-ux/wc-core-components/agent/Stack.md
  - use for `DBSelect` or `Select` the file node_modules/@db-ux/wc-core-components/agent/Select.md
  - use for `DBSection` or `Section` the file node_modules/@db-ux/wc-core-components/agent/Section.md
  - use for `DBRadio` or `Radio` the file node_modules/@db-ux/wc-core-components/agent/Radio.md
  - use for `DBPopover` or `Popover` the file node_modules/@db-ux/wc-core-components/agent/Popover.md
  - use for `DBPage` or `Page` the file node_modules/@db-ux/wc-core-components/agent/Page.md
  - use for `DBNotification` or `Notification` the file node_modules/@db-ux/wc-core-components/agent/Notification.md
  - use for `DBNavigationItem` or `NavigationItem` the file node_modules/@db-ux/wc-core-components/agent/NavigationItem.md
  - use for `DBNavigation` or `Navigation` the file node_modules/@db-ux/wc-core-components/agent/Navigation.md
  - use for `DBLink` or `Link` the file node_modules/@db-ux/wc-core-components/agent/Link.md
  - use for `DBInput` or `Input` the file node_modules/@db-ux/wc-core-components/agent/Input.md
  - use for `DBInfotext` or `Infotext` the file node_modules/@db-ux/wc-core-components/agent/Infotext.md
  - use for `DBIcon` or `Icon` the file node_modules/@db-ux/wc-core-components/agent/Icon.md
  - use for `DBHeader` or `Header` the file node_modules/@db-ux/wc-core-components/agent/Header.md
  - use for `DBDivider` or `Divider` the file node_modules/@db-ux/wc-core-components/agent/Divider.md
  - use for `DBCustomSelect` or `CustomSelect` the file node_modules/@db-ux/wc-core-components/agent/CustomSelect.md
  - use for `DBCheckbox` or `Checkbox` the file node_modules/@db-ux/wc-core-components/agent/Checkbox.md
  - use for `DBCard` or `Card` the file node_modules/@db-ux/wc-core-components/agent/Card.md
  - use for `DBButton` or `Button` the file node_modules/@db-ux/wc-core-components/agent/Button.md
  - use for `DBBrand` or `Brand` the file node_modules/@db-ux/wc-core-components/agent/Brand.md
  - use for `DBBadge` or `Badge` the file node_modules/@db-ux/wc-core-components/agent/Badge.md
  - use for `DBAccordionItem` or `AccordionItem` the file node_modules/@db-ux/wc-core-components/agent/AccordionItem.md
  - use for `DBAccordion` or `Accordion` the file node_modules/@db-ux/wc-core-components/agent/Accordion.md
